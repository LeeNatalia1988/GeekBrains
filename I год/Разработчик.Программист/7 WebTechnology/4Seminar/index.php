...
$experience = [
    [
        ...
        'date_end' => 'Current',
        'escription' => 'Conducting second-party audits to verify production 
        processes meet established requirements',
        ],
        [
        'proffesion' => 'QMS specialist',
        'date_start' => 'May 2017',
        'date_end' => 'April 2020',
        'escription' => 'Conducting second-party audits to verify production 
        processes meet established requirements',
        ...
        [
        'proffesion' => 'Head of Quality Service',
        'date_start' => 'October 2015',
        'date_end' => 'May 2017',
        'escription' => 'Conducting second-party audits to verify production 
        processes meet established requirements. Quality service management.',
        ],
    ]
?>
<!DOCTYPE html>
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
              ...
              <?php for ($i = 0; $i < count($experience); $i++):?>
                <div class="w3-container">
                    <h5 class="w3-opacity"><b><?= $experience[$i]['proffesion'] ?></b></h5>
                    <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $experience[$i]['date_start'] ?> - <span 
                    class="w3-tag w3-teal w3-round"><?= $experience[$i]['date_end'] ?></span></h6>
                    <p><?= $experience[$i]['escription'] ?></p>
                    <hr>
                    </div>
              <?php endfor; ?>
